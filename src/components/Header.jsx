...
const Header = ({ 
  ...
  const allProducts = [
    ...
    { id: 'embroideredMensPoloTShirts', name: "Men's Polo T-Shirts", cat: 'clothing-bags', price: 320 },
    { id: 'womenPoloTShirts', name: "Women's Polo T-shirts", cat: 'clothing-bags', price: 320 },
